...
export const envSchema = z.object({
  ...
  // Puppeteer Settings
  PUPPETEER_SKIP_CHROMIUM_DOWNLOAD: z.string().transform(val => val === 'true').default('false'),
  ...
  // External APIs
  SYOSETU_API_BASE_URL: z.string().default('https://api.syosetu.com/novelapi/api/'),
